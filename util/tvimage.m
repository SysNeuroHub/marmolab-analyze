...
p.addParameter('XLabel','',@(x) ischar(x) || isempty(x));
p.addParameter('YLabel','',@(x) ischar(x) || isempty(x));
p.addParameter('XNTicks',5,@(x) isnumeric(x) || isempty(x));
p.addParameter('YNTicks',5,@(x) isnumeric(x) || isempty(x));
p.addParameter('XRange',[],@(x) isnumeric(x) || isempty(x));
p.addParameter('YRange',[],@(x) isnumeric(x) || isempty(x));
p.addParameter('CLim',[],@(x) isnumeric(x) || isempty(x));
...
XLabel = args.XLabel;
YLabel = args.YLabel;
XNTicks = args.XNTicks;
YNTicks = args.YNTicks;
